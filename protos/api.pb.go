...
var file_api_proto_rawDesc = []byte{
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x71, 0x0a, 0x16, 0x43, 0x75, 0x73, 0x74, 0x6f,
	...
	0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x42, 0x25, 0x5a, 0x23, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_api_proto_goTypes = []interface{}{
	...
	(*CustomerCreationResult)(nil),     // 4: subs.CustomerCreationResult
	(*CatalogCreationResult)(nil),      // 5: subs.CatalogCreationResult
	(*SubscriptionCreationResult)(nil), // 6: subs.SubscriptionCreationResult
	(*HttpResponse)(nil),               // 7: subs.HttpResponse
...
var file_api_proto_depIdxs = []int32{
	...
	5,  // 4: subs.SubscriptionSetupResponse.catalog_creation_result:type_name -> subs.CatalogCreationResult
	...
	12, // 6: subs.GetSubscriptionsResponse.subscriptions:type_name -> subs.GetSubscriptionsResponse.SubscriptionsEntry
	7,  // 7: subs.CustomerCreationResult.http_response:type_name -> subs.HttpResponse
	13, // 8: subs.CustomerCreationResult.user:type_name -> subs.User
	7,  // 9: subs.CatalogCreationResult.http_response:type_name -> subs.HttpResponse
	8,  // 10: subs.CatalogCreationResult.subscription_plan:type_name -> subs.SubscriptionCatalogObject
	7,  // 11: subs.SubscriptionCreationResult.http_response:type_name -> subs.HttpResponse
	15, // 12: subs.SubscriptionCreationResult.subscription:type_name -> subs.Subscription
	9,  // 13: subs.SubscriptionCatalogObject.subscription_plan_data:type_name -> subs.SubscriptionPlanData
	15, // 14: subs.SubscriptionCatalogObject.subscriptions:type_name -> subs.Subscription
	14, // 15: subs.SubscriptionPlanData.subscription_frequency:type_name -> subs.SubscriptionFrequency
	4,  // 16: subs.SubscriptionSetupResponse.CustomerCreationResultsEntry.value:type_name -> subs.CustomerCreationResult
	6,  // 17: subs.SubscriptionSetupResponse.SubscriptionCreationResultsEntry.value:type_name -> subs.SubscriptionCreationResult
	8,  // 18: subs.GetSubscriptionsResponse.SubscriptionsEntry.value:type_name -> subs.SubscriptionCatalogObject
	0,  // 19: subs.SubscriptionService.SetupSubscription:input_type -> subs.SubscriptionSetupRequest
	2,  // 20: subs.SubscriptionService.GetSubscriptions:input_type -> subs.GetSubscriptionRequest
	1,  // 21: subs.SubscriptionService.SetupSubscription:output_type -> subs.SubscriptionSetupResponse
	3,  // 22: subs.SubscriptionService.GetSubscriptions:output_type -> subs.GetSubscriptionsResponse
